    ...
    public class StatusService
    {
        ...
        public async Task<List<StatusResponse>> GetStatuses()
        {
            ...
            try
            {
                ...
                var response = await _httpClient.GetFromJsonAsync<List<StatusResponse>>("api/statuses");
            ...
            {
                throw new Exception("Error al obtener los estados. Revisar conexión a internet.");
            }
            catch (Exception ex)
            {
