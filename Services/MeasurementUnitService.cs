    ...
    public class MeasurementUnitService
    {
        ...
        public async Task<List<MeasurementUnitResponse>> GetMeasurementUnits()
        {
            ...
            try
            {
                ...
                var response = await _httpClient.GetFromJsonAsync<List<MeasurementUnitResponse>>("api/measurementUnits");
            ...
            {
                throw new Exception("Error al obtener las unidades de medida. Revisar conexión a internet.");
            }
            catch (Exception ex)
            {
